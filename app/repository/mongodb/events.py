...
class EventsRepository:
    ...
    def create_event(event: Event) -> Event | None:
        try:
            ...
            result = EventsRepository.events_collection.insert_one(event.to_dict())
    ...
    def get_events(
        ...
        try:
            ...
            docs = EventsRepository.events_collection.find(query)
    ...
    def delete_event(event_id: str | ObjectId) -> bool:
        try:
            ...
            result = EventsRepository.events_collection.delete_one(
                {"_id": event_id}
            )
